      ...
      <Paper style={{ margin: '5%', padding: '3%', marginTop: 0 }} zDepth={4}>
        ...
        <Table>
          <TableHeader displaySelectAll={false} adjustForCheckbox={false}>
            ...
            <TableRow>
              <TableHeaderColumn tooltip="Rut">Titulo</TableHeaderColumn>
              <TableHeaderColumn tooltip="Name">Texto</TableHeaderColumn>
              <TableHeaderColumn tooltip="Email">Colegio</TableHeaderColumn>
              <TableHeaderColumn tooltip="Celular">Usuario</TableHeaderColumn>
              <TableHeaderColumn tooltip="Celular">Tipo</TableHeaderColumn>
              <TableHeaderColumn tooltip="Celular">Tabla</TableHeaderColumn>
